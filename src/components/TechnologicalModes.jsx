        ...
        <div>
            <TableTechnologicalModel>
                <Tr>
                    ...
                    <Th colSpan="4" style={{position:'relative', position:'sticky', top:'0'}} >Технологические режимы эксплуатации месторождений <FontAwesomeIcon style={{position:'absolute', right:'5px', top:'17px', cursor:'pointer'}} icon={faEdit} /> </Th>
                </Tr>
                <Tr>
