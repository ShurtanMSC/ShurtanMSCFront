                            ...
                            <Table>
                                ...
                                <Tr>
                                    <Td>{uppgDatabase&&uppgDatabase[1] ?
                                      ...
                                      (Math.round(uppgDatabase[1].nakoplenniy_obyom_za_pered_mesyach*new Date().getMonth()*100)/100)+(Math.round(uppgDatabase[1].nakoplenniy_obyom_za_pered_mesyach*100)/100)
                                      : 0}
                                    </Td>
